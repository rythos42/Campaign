            ...
            <div data-bind="dialog: { title: Translation.getString('giveTerritoryBonusDialogTitle') }, dialogOpenClose: dialogOpenClose">
                <ul>
                    <li class="entry-field">
                        ...
                        <input type="text" id="UserSelection" data-bind="jqAuto: { value: selectedUser, source: UserManager.getUsers, inputProp: 'label', labelProp: 'label', valueProp: 'object' }, validationElement: selectedUser"></select>
